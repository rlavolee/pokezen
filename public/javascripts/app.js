...
var _user$project$Models$initialModel = function (route) {
	return {pokemons: _krisajenkins$remotedata$RemoteData$Loading, route: route};
};
var _user$project$Models$Model = F2(
	function (a, b) {
		return {pokemons: a, route: b};
	});
var _user$project$Models$Pokemon = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _user$project$Models$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Models$PokemonRoute = function (a) {
	return {ctor: 'PokemonRoute', _0: a};
};
var _user$project$Models$PokemonsRoute = {ctor: 'PokemonsRoute'};
var _user$project$Models$Home = {ctor: 'Home'};

var _user$project$Msgs$OnLocationChange = function (a) {
	return {ctor: 'OnLocationChange', _0: a};
};
var _user$project$Msgs$OnFetchPokemons = function (a) {
	return {ctor: 'OnFetchPokemons', _0: a};
};

var _user$project$Commands$pokemonDecoder = A3(
	...
	A3(
		...
		'_id',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models$Pokemon)));
var _user$project$Commands$pokemonsDecoder = _elm_lang$core$Json_Decode$list(_user$project$Commands$pokemonDecoder);
var _user$project$Commands$fetchPokemonUrl = function (name) {
	return A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:9000/pokemon/', name);
};
var _user$project$Commands$fetchPokemonsUrl = 'http://localhost:9000/pokemon/?page=0&limit=20';
var _user$project$Commands$fetchPokemons = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Msgs$OnFetchPokemons,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$Commands$fetchPokemonsUrl, _user$project$Commands$pokemonsDecoder)));

var _user$project$Routing_Routes$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				_user$project$Models$PokemonRoute,
				A2(
					_evancz$url_parser$UrlParser_ops['</>'],
					_evancz$url_parser$UrlParser$s('pokemon'),
					_evancz$url_parser$UrlParser$string)),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Models$PokemonsRoute,
					_evancz$url_parser$UrlParser$s('pokemon')),
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$Routing_Routes$parseLocation = function (location) {
	var _p0 = A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Routing_Routes$matchers, location);
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		if (_p0.ctor === 'OnFetchPokemons') {
			...
			var newRoute = _user$project$Routing_Routes$parseLocation(_p0._0);
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Pokemon_List$row = function (pokemon) {
	return A2(
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						'https://debois.github.io/elm-mdl/assets/images/christoffer.jpg',
						{ctor: '[]'}),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(pokemon.name),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Pokemon_List$list = function (pokemons) {
	return A2(
		_debois$elm_mdl$Material_List$ul,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Pokemon_List$row, pokemons));
};
var _user$project$Pokemon_List$maybeList = function (response) {
	var _p0 = response;
	switch (_p0.ctor) {
		case 'NotAsked':
		...
		case 'Success':
			return _user$project$Pokemon_List$list(_p0._0);
		default:
			return _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(_p0._0));
	}
};
var _user$project$Pokemon_List$nav = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('pokemons'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _user$project$Pokemon_List$view = function (response) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Pokemon_List$nav,
					_1: {
						ctor: '::',
						_0: _user$project$Pokemon_List$maybeList(response),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Pokemon_Detail$pokemonDetailPage = F2(
	function (model, pokezenId) {
		var _p0 = model.pokemons;
		switch (_p0.ctor) {
			case 'NotAsked':
				return _elm_lang$html$Html$text('');
			case 'Loading':
			...
			case 'Success':
				return _elm_lang$html$Html$text('ok');
			default:
				return _elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(_p0._0));
		}
	});
var _user$project$Pokemon_Detail$form = function (pokemon) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Pokemon_Detail$nav = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Pokemon_Detail$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Pokemon_Detail$nav(model),
			_1: {
				ctor: '::',
				_0: _user$project$Pokemon_Detail$form(model),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$Pokemon_Home$view = A2(
	_debois$elm_mdl$Material_Grid$grid,
	{
		ctor: '::',
...
var _user$project$Pokemon_Home$white = _debois$elm_mdl$Material_Color$text(_debois$elm_mdl$Material_Color$white);
...
var _user$project$View$page = function (model) {
	...
	switch (_p0.ctor) {
		case 'Home':
			return _user$project$Pokemon_Home$view;
		case 'PokemonsRoute':
			return _user$project$Pokemon_List$view(model.pokemons);
		case 'PokemonRoute':
			return A2(_user$project$Pokemon_Detail$pokemonDetailPage, model, _p0._0);
		default:
...
var _user$project$Main$init = function (location) {
	var currentRoute = _user$project$Routing_Routes$parseLocation(location);
	return {
		ctor: '_Tuple2',
